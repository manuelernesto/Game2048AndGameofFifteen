...
class TestGameBoard {
    ...
    private fun testAllAny(gameBoard: GameBoard<Int>) {
        ...
        Assert.assertTrue(buildString {
            appendln("'io.github.manuelernesto.board.all { it != 0 }' should give the same result as '!io.github.manuelernesto.board.any { it == 0 }' for the io.github.manuelernesto.board")
