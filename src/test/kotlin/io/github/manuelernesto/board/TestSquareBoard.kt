...
class TestSquareBoard {
    ...
    fun test07AllCells() {
        ...
        val cells = board.getAllCells().sortedWith(compareBy<Cell> { it.i }.thenBy { it.j })
        Assert.assertEquals(
            "Wrong result for 'getAllCells()' for the io.github.manuelernesto.board of width 3.",
    ...
    fun test08Cell() {
        ...
        Assert.assertEquals(
            "The io.github.manuelernesto.board of width 4 should contain the cell (2, 3).",
            "(2, 3)", cell.toString()
        )
    }
    ...
    fun test09NoCell() {
        ...
        Assert.assertEquals("The io.github.manuelernesto.board of width 4 should contain the cell (10, 10).", null, cell)
    }
    ...
    fun test15Neighbour() {
        with(createSquareBoard(4)) {
            ...
            Assert.assertNotNull("The io.github.manuelernesto.board of width 4 should contain the cell (2, 3).", cell)
    ...
    fun test16NullableNeighbour() {
        with(createSquareBoard(4)) {
            ...
            Assert.assertNotNull("The io.github.manuelernesto.board of width 4 should contain the cell (4, 4).", cell)
